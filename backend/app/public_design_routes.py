...
def nav(active="pocetna"):
    items=[("pocetna","/pocetna","Početna"),("ponude","/ponude","Ponude"),("zasto","/problem-bacanja-hrane","Zašto"),("rezervacije","/moje-rezervacije","Rezervacije"),("partner","/partner/kontrolna-tabla","Partneri"),("finansije","/admin/finance-console","Finansije"),("dizajn","/dizajn-sistem","Dizajn sistem")]
...
def home_page():
    ...
    <section class='section impact-panel'><span class='badge'>Zašto postoji Sačuvaj Hranu</span><h2>Bacanje hrane je realan problem, ali svaki obrok može da promeni smer.</h2><p class='lead'>Srbija godišnje gubi stotine hiljada tona hrane, dok pekare, restorani i prodavnice svakog dana imaju višak koji može brzo da pronađe kupca.</p><div class='impact-grid'><div class='impact-stat'><b>2.000 t</b><span>hrane se dnevno pominje kao procena otpada u domaćim izveštajima.</span></div><div class='impact-stat'><b>730k+</b><span>tona hrane godišnje, prema međunarodnim procenama otpada od hrane.</span></div><div class='impact-stat'><b>240-350M €</b><span>procena godišnjeg ekonomskog gubitka zbog bačene hrane.</span></div><div class='impact-stat'><b>10-15%</b><span>neprodate dnevne proizvodnje kod pekara često ostaje na kraju dana.</span></div></div><div class='gps-actions'><a class='btn' href='/problem-bacanja-hrane'>Saznaj zašto ovo rešavamo</a><a class='btn secondary' href='/partner/onboarding'>Uključi lokal</a></div></section>
