...
class Store(Base):
    ...
    seller_type: Mapped[str] = mapped_column(String(40), default="business", index=True)
    agreement_accepted: Mapped[bool] = mapped_column(Boolean, default=False)
    agreement_version: Mapped[str | None] = mapped_column(String(60), nullable=True)
    agreement_accepted_at: Mapped[datetime | None] = mapped_column(DateTime, nullable=True)
    liability_accepted: Mapped[bool] = mapped_column(Boolean, default=False)
    commission_terms_accepted: Mapped[bool] = mapped_column(Boolean, default=False)
    ...
    loyalty_tier: Mapped[str] = mapped_column(String(40), default="start")
...
class Reservation(Base):
    ...
    seller_invoice_due_at: Mapped[datetime | None] = mapped_column(DateTime, nullable=True)
    created_at: Mapped[datetime] = mapped_column(DateTime, default=datetime.utcnow)
    updated_at: Mapped[datetime] = mapped_column(DateTime, default=datetime.utcnow, onupdate=datetime.utcnow)
